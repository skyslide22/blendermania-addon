...
class PannelsPropertyGroup(bpy.types.PropertyGroup):
    ...
    NU_xml_scale                : FloatProperty(name="Obj Scales",               default=1.0, min=0, max=256, step=100)
    ...
    NU_xml_lightGlobDistance    : FloatProperty(name="Light Distance",           default=32.0, min=0, max=256, step=1)
    ...
    NU_xml_gridAndLeviOffsetX   : FloatProperty(name="Sync X",          default=8.0, min=0, max=256, step=100, update=updateGridAndLevi)
    NU_xml_gridAndLeviOffsetY   : FloatProperty(name="Synx Y",          default=8.0, min=0, max=256, step=100, update=updateGridAndLevi)
